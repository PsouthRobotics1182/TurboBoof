...
public class FinedementalMatrii {
	 ...
	 * fundamental matrix.
	 */
	public static List<AssociatedPair> computeMatches(GrayU8 left , GrayU8 right ) {
		DetectDescribePoint detDesc = FactoryDetectDescribe.surfStable(
				new ConfigFastHessian(1, 2, 200, 1,
						9, 4, 4), null,null, GrayU8.class);
//		DetectDescribePoint detDesc = FactoryDetectDescribe.sift(null,new ConfigSiftDetector(2,0,200,5),null,null);
		...
		OkayAssociator<GrayU8,BrightFeature> findMatches =
				new OkayAssociator<>(detDesc, associate, GrayU8.class);
